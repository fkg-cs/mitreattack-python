...
from fkg_cs.group_page import get_group_info
...
app = Flask(__name__, static_folder=r'C:\Users\franc\Desktop\mitrepy\mitreattack-python\static',template_folder=r'C:\Users\franc\Desktop\mitrepy\mitreattack-python\static\templates')
@app.route('/')
def home_page():
