...
def index_ics_matrix():
    ...
    output_list["git_link"] = 'https://github.com/fkg-cs/mitreattack-python/blob/master/CLI_python_utils_for_MitreAttackData_fkg_cs/ScraperJson/mapping_results/ics_techniques_riskscores_mapping.csv'
