...
def index_enterprise_matrix():
    ...
    output_list["git_link"] = 'https://github.com/fkg-cs/mitreattack-python/blob/master/CLI_py_utils_by_fkg_cs/ScraperJson/mapping_results/enterprise_techniques_riskscores_mapping.csv'
