...
def index_mobile_matrix():
    ...
    output_list['title'] = "MOBILE ATT&CK MATRIX"
    ...
    output_list["git_link"] = 'https://github.com/fkg-cs/mitreattack-python/blob/master/CLI_python_utils_for_MitreAttackData_fkg_cs/ScraperJson/mapping_results/mobile_techniques_riskscores_mapping.csv'
