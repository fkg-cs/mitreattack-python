...
def get_technique_risk_scores(techniqueKeyWords):
    ...
    print(f"---REPORT:number of CVEs with required metrics and matching keywords:{n_cves_with_metrics_and_match} out of {n_cves} CVEs---")
...
if __name__ == "__main__":
    ...
    get_technique_risk_scores("Credential Theft")