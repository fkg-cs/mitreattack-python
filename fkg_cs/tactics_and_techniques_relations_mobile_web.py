...
def get_mobile_matrix():
    ...
    output_list['header'] = " TACTICS AND TECHNIQUES RELATIONS IN MOBILE ATT&CK MATRIX "
    output_list["tactics"] = []
    ...
    output_list[
        "report"] = f"--> REPORT: {n_tactics} TACTICS FOUND , {n_techniques} TECHNIQUES FOUND , {n_subtechniques} SUBTECHNIQUES FOUND <--"
    return output_list
