...
def main():
    ...
    for id, software_used in all_software_used_by_all_groups.items():
        ...
        print(f"{i_groups}) GROUP '{group_name}' (ATT&CK ID: {group_external_id}) has used {len(software_used)} software in MOBILE ATT&CK:")
    ...
    print(f"\n --> REPORT: OUT OF {n_groups} GROUPS OPERATING IN MOBILE ATT&CK MATRIX CONTEXT , {n_groups_using_software} GROUPS ARE KNOWND TO USE {n_software_used_by_all_groups} SOFTWARES <--\n")
