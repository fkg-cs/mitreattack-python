...
def main():
    ...
    mitre_attack_data = MitreAttackData("../json/json_matrix/enterprise-attack.json")
    ...
    for tactic in tactics:
        ...
        print(f"{i}) {tactic.name} (ATT&CK ID: {external_id}) : {tactic.description}\n More at: {url}\n")
        ...
        for technique in techniques:
            ...
            print(f"   {i}.{j}) {technique.name} (ATT&CK ID: {technique_external_id}) targets ")  #: {technique.description}#stampa descrizione ma riduce legibilità
