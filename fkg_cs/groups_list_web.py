...
#popolo gruppi mobile
    ...
    #print(f"Retrieved {n_enterprise_groups+n_ics_groups+n_n_mobile_groups} ATT&CK groups: ENTERPRISE [{n_enterprise_groups}], ICS[{n_ics_groups}] , MOBILE [{n_mobile_groups}].")
