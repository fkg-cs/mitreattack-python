...
def get_enterprise_techniques_risk_scores():
    output_file_path=r"..\CLI_py_utils_by_fkg_cs\Scraper Json\mapping"

    mitre_attack_data = MitreAttackData("../Janus/json/json_matrix/enterprise-attack.json")
    techniques = mitre_attack_data.get_techniques(remove_revoked_deprecated=True)

    print("----------Scraping CVSS3.1 metrics for all Enterprise tactics------------")
    print(f"Saving score mapping of techniques in: {output_file_path}")

    output_string="" #format of csv is Technique ATT&CK ID,cveid matching,cveid matching 2,......,cveid matching n, [risk_score]
